# generated by `swift package completion-tool generate-fish-script`
...
complete -c swift -n '__fish_swift_using_command swift run' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift run' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift run' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift run' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift run' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift run' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift build' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift build' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift build' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift build' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift build' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift build' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift test' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift test' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift test' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift test' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift test' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift test' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package' -f -a 'dump-symbol-graph' -d 'Dump Symbol Graph'
...
complete -c swift -n '__fish_swift_using_command swift package' -f -a 'archive-source' -d 'Create a source archive for the package'
...
complete -c swift -n '__fish_swift_using_command swift package clean' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package clean' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package clean' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package clean' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package clean' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package clean' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package purge-cache' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package purge-cache' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package purge-cache' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package purge-cache' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package purge-cache' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package purge-cache' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package reset' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package reset' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package reset' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package reset' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package reset' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package reset' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package update' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package update' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package update' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package update' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package update' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package update' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package describe' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package describe' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package describe' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package describe' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package describe' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package describe' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package describe' -f -r -l type -d 'json | text'
...
complete -c swift -n '__fish_swift_using_command swift package init' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package init' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package init' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package init' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package init' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package init' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package init' -f -r -l type -d 'Package type: empty | library | executable | system-module | manifest'
...
complete -c swift -n '__fish_swift_using_command swift package _format' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package _format' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package _format' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package _format' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package _format' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package _format' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package experimental-api-diff' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package experimental-api-diff' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package experimental-api-diff' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package experimental-api-diff' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package experimental-api-diff' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package experimental-api-diff' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package dump-symbol-graph' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package dump-symbol-graph' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package dump-symbol-graph' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package dump-symbol-graph' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package dump-symbol-graph' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package dump-symbol-graph' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package dump-pif' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package dump-pif' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package dump-pif' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package dump-pif' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package dump-pif' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package dump-pif' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package dump-package' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package dump-package' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package dump-package' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package dump-package' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package dump-package' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package dump-package' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package edit' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package edit' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package edit' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package edit' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package edit' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package edit' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package unedit' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package unedit' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package unedit' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package unedit' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package unedit' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package unedit' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package config set-mirror' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package config set-mirror' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package config set-mirror' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package config set-mirror' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package config set-mirror' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package config set-mirror' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package config unset-mirror' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package config unset-mirror' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package config unset-mirror' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package config unset-mirror' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package config unset-mirror' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package config unset-mirror' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package config get-mirror' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package config get-mirror' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package config get-mirror' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package config get-mirror' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package config get-mirror' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package config get-mirror' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package resolve' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package resolve' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package resolve' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package resolve' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package resolve' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package resolve' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package fetch' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package fetch' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package fetch' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package fetch' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package fetch' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package fetch' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package show-dependencies' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package show-dependencies' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package show-dependencies' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package show-dependencies' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package show-dependencies' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package show-dependencies' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package show-dependencies' -f -r -l format -d 'text | dot | json | flatlist'
...
complete -c swift -n '__fish_swift_using_command swift package tools-version' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package tools-version' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package tools-version' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package tools-version' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package tools-version' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package tools-version' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package tools-version' -f -r -l format -d 'text | dot | json | flatlist'
...
complete -c swift -n '__fish_swift_using_command swift package generate-xcodeproj' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package generate-xcodeproj' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package generate-xcodeproj' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package generate-xcodeproj' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package generate-xcodeproj' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package generate-xcodeproj' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package compute-checksum' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package compute-checksum' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package compute-checksum' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package compute-checksum' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package compute-checksum' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package compute-checksum' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -o Xcc -d 'Pass flag through to all C compiler invocations'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -o Xswiftc -d 'Pass flag through to all Swift compiler invocations'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -o Xlinker -d 'Pass flag through to all linker invocations'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -o Xcxx -d 'Pass flag through to all C++ compiler invocations'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l configuration -s c -d 'Build with configuration'
complete -c swift -n '__fish_swift_using_command swift package archive-source --configuration' -f -k -a 'debug release'
complete -c swift -n '__fish_swift_using_command swift package archive-source -c' -f -k -a 'debug release'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l build-path -d 'Specify build/cache directory'
complete -c swift -n '__fish_swift_using_command swift package archive-source --build-path' -f -a '(__fish_complete_directories)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l cache-path -d 'Specify the shared cache directory'
complete -c swift -n '__fish_swift_using_command swift package archive-source --cache-path' -f -a '(__fish_complete_directories)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l enable-repository-cache -d 'Use a shared cache when fetching repositories'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l chdir -s C
complete -c swift -n '__fish_swift_using_command swift package archive-source --chdir' -f -a '(__fish_complete_directories)'
complete -c swift -n '__fish_swift_using_command swift package archive-source -C' -f -a '(__fish_complete_directories)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l package-path -d 'Change working directory before any other operation'
complete -c swift -n '__fish_swift_using_command swift package archive-source --package-path' -f -a '(__fish_complete_directories)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l multiroot-data-file
complete -c swift -n '__fish_swift_using_command swift package archive-source --multiroot-data-file' -f -a '(for i in *.{}; echo $i;end)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l enable-prefetching
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l disable-prefetching
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l verbose -s v -d 'Increase verbosity of informational output'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l disable-sandbox -d 'Disable using the sandbox when executing subprocesses'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l manifest-cache -d 'Caching mode of Package.swift manifests (shared: shared cache, local: package\'s build directory, none: disabled'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l destination
complete -c swift -n '__fish_swift_using_command swift package archive-source --destination' -f -a '(for i in *.{}; echo $i;end)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l triple
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l sdk
complete -c swift -n '__fish_swift_using_command swift package archive-source --sdk' -f -a '(__fish_complete_directories)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l toolchain
complete -c swift -n '__fish_swift_using_command swift package archive-source --toolchain' -f -a '(__fish_complete_directories)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l static-swift-stdlib -d 'Link Swift stdlib statically'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l skip-update -d 'Skip updating dependencies from their remote during a resolution'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l sanitize -d 'Turn on runtime checks for erroneous behavior, possible values: address, thread, undefined, scudo'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l enable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l enable-index-store -d 'Enable or disable indexing-while-building feature'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l enable-parseable-module-interfaces
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l trace-resolver
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l jobs -s j -d 'The number of jobs to spawn in parallel during the build process'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l enable-build-manifest-caching
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l disable-build-manifest-caching
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l emit-swift-module-separately
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l use-integrated-swift-driver
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l experimental-explicit-module-build
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l print-manifest-job-graph -d 'Write the command graph for the build manifest as a graphviz file'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l build-system
complete -c swift -n '__fish_swift_using_command swift package archive-source --build-system' -f -k -a 'native xcode'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l netrc
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -l netrc-optional
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -l netrc-file
complete -c swift -n '__fish_swift_using_command swift package archive-source --netrc-file' -f -a '(for i in *.{}; echo $i;end)'
complete -c swift -n '__fish_swift_using_command swift package archive-source' -f -r -s o -l output -d 'The absolute or relative path for the generated source archive'
complete -c swift -n '__fish_swift_using_command swift package archive-source -o' -f -a '(__fish_complete_directories)'
complete -c swift -n '__fish_swift_using_command swift package archive-source --output' -f -a '(__fish_complete_directories)'
...
complete -c swift -n '__fish_swift_using_command swift package completion-tool' -f -l disable-repository-cache -d 'Use a shared cache when fetching repositories'
...
complete -c swift -n '__fish_swift_using_command swift package completion-tool' -f -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '__fish_swift_using_command swift package completion-tool' -f -l disable-code-coverage -d 'Enable code coverage'
complete -c swift -n '__fish_swift_using_command swift package completion-tool' -f -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '__fish_swift_using_command swift package completion-tool' -f -l auto-index-store -d 'Enable or disable indexing-while-building feature'
...
complete -c swift -n '__fish_swift_using_command swift package completion-tool' -f -l disable-index-store -d 'Enable or disable indexing-while-building feature'
